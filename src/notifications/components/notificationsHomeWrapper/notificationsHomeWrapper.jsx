...
export const NotificationsHomeWrapper = ({user, workspace, signature, logo, sound}) => {
  return (
    <NotificationsHomeProvider user={user} workspace={workspace} signature={signature} logo={logo} sound={sound}>
      <Component />
